...
class NbowModel():
    def __init__(self, vocab_sz, epochs, batch_size):
        print("** here")
        ...
        print(f"vocab_sz: {self.vocab_sz}")
    ...
    def fit(self, X, y):
        ...
        self.model.fit(x=res, y=y, batch_size=self.batch_size, 
                       epochs=self.epochs, validation_split=.2)
    ...
    @property
    def model_dict(self): 
        return {'vectorizer':self.cv, 'model': self.model, "epochs": self.epochs, "batch_size": self.batch_size}
    ...
    def from_dict(cls, model_dict):
        ...
        ), model_dict["epochs"], model_dict["batch_size"])
        nbow_model.epochs = model_dict["epochs"]
